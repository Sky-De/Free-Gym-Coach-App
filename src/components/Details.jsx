...
import EquipmentImage1 from "../assets/icons/equipment1.png";
    ...
    <Stack gap="60px" sx={{ flexDirection: { lg: "row"}, p: "20px", alignItems: "center"}}>
      ...
      <Stack sx={{ gap: { lg: "35px", xs: "20px" }}}>
        ...
        <Typography variant="h6">
          ...
          <span style={{ textTransform: 'capitalize', color: "#ff2625" }}>{name} {" "}</span> 
          bup is one of the best <br /> exercises to target your 
          <span style={{ textTransform: 'capitalize', color: "#ff2625" }}>{" "} {target}</span>. 
          It will help you improve your{' '} <br /> mood and gain energy.
          </Typography>
          <Stack gap="30px" sx={{ flexDirection: { lg : "column" , md: "row", sm : "row"}, marginTop: { lg : "20px" , md: "40px", sm : "40px", xs:"20px"}}}>
            {extraDetail.map((item,index) => (
            <Stack key={index} direction="row" gap="24px" alignItems="center">
              <Button title={item.title} sx={{ background: "#fff2db", borderRadius: "50%", width: "100px", height: "100px"}}>
